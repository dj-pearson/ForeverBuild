...
function makeEveryOrSomeMethod(iterator, callbackArgsListMaker, initialState) {
    return (state, node, expression, args) => {
        ...
        state.prereq(luau_ast_1.default.create(luau_ast_1.default.SyntaxKind.ForStatement, {
            ...
            expression: luau_ast_1.default.call(iterator, [expression]),
...
const READONLY_ARRAY_METHODS = {
    ...
    join: (state, node, expression, args) => {
        ...
        if (indexType && !(0, types_1.isDefinitelyType)(indexType, types_1.isStringType, types_1.isNumberType)) {
            ...
            state.prereq(luau_ast_1.default.create(luau_ast_1.default.SyntaxKind.ForStatement, {
                ids: luau_ast_1.default.list.make(keyId, valueId),
                expression: luau_ast_1.default.call(luau_ast_1.default.globals.ipairs, [expression]),
                statements: luau_ast_1.default.list.make(luau_ast_1.default.create(luau_ast_1.default.SyntaxKind.Assignment, {
    ...
    every: makeEveryMethod(luau_ast_1.default.globals.ipairs, (keyId, valueId, expression) => [
        valueId,
        (0, offset_1.offset)(keyId, -1),
        expression,
    ]),
    some: makeSomeMethod(luau_ast_1.default.globals.ipairs, (keyId, valueId, expression) => [valueId, (0, offset_1.offset)(keyId, -1), expression]),
