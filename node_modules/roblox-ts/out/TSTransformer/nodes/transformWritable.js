...
function transformWritableExpression(state, node, readAfterWrite) {
    ...
    if (typescript_1.default.isPropertyAccessExpression(node)) {
        ...
        return luau_ast_1.default.property(readAfterWrite ? state.pushToVarIfComplex(expression, "exp") : (0, convertToIndexableExpression_1.convertToIndexableExpression)(expression), node.name.text);
    }
