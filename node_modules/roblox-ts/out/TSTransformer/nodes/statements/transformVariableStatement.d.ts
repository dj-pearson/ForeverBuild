...
export declare function transformVariable(state: TransformState, identifier: ts.Identifier, right?: luau.Expression): [value: luau.PropertyAccessExpression | luau.AnyIdentifier, prereqs: luau.List<luau.Statement<keyof luau.StatementByKind>>];
