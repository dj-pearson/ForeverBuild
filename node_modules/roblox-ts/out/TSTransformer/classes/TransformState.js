...
const luau_ast_2 = require("@roblox-ts/luau-ast");
...
class TransformState {
    ...
    debugRender(node) {
        const state = new luau_ast_2.RenderState();
        (0, luau_ast_2.solveTempIds)(state, node);
        return (0, luau_ast_2.render)(state, node);
    }
    debugRenderList(list) {
        const state = new luau_ast_2.RenderState();
        (0, luau_ast_2.solveTempIds)(state, list);
        return (0, luau_ast_2.renderStatements)(state, list);
    }
    pushTryUsesStack() {
        const tryUses = {
            usesReturn: false,
    ...
    pushToVar(expression, name) {
        const temp = luau_ast_1.default.tempId(name);
