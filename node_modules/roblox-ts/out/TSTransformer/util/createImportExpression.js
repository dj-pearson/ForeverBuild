...
function getNodeModulesImport(state, moduleSpecifier, moduleFilePath) {
    ...
    return (0, expressionChain_1.propertyAccessExpressionChain)(luau_ast_1.default.call(state.TS(moduleSpecifier.parent, "getModule"), [
...
function createImportExpression(state, sourceFile, moduleSpecifier) {
    ...
    importPathExpressions.push(luau_ast_1.default.globals.script);
    ...
    return luau_ast_1.default.call(state.TS(moduleSpecifier.parent, "import"), importPathExpressions);
}
