...
async function init(argv, mode) {
    ...
    const [npmAvailable, pnpmAvailable, yarnAvailable, gitAvailable] = (await Promise.allSettled(["npm", "pnpm", "yarn", "git"].map(v => (0, lookpath_1.lookpath)(v)))).map(v => v !== undefined);
    ...
    const { git = (_b = (_a = argv.git) !== null && _a !== void 0 ? _a : (argv.yes && gitAvailable)) !== null && _b !== void 0 ? _b : false, eslint = (_d = (_c = argv.eslint) !== null && _c !== void 0 ? _c : argv.yes) !== null && _d !== void 0 ? _d : false, prettier = (_f = (_e = argv.prettier) !== null && _e !== void 0 ? _e : argv.yes) !== null && _f !== void 0 ? _f : false, vscode = (_h = (_g = argv.vscode) !== null && _g !== void 0 ? _g : argv.yes) !== null && _h !== void 0 ? _h : false, packageManager = (_j = argv.packageManager) !== null && _j !== void 0 ? _j : PackageManager.NPM, } = await (0, prompts_1.default)([
        {
